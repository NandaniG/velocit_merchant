...
class OrderReviewSubActivity extends StatefulWidget {
  OrderReviewSubActivity({Key? key}) : super(key: key);
...
class _OrderReviewSubActivityState extends State<OrderReviewSubActivity> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(backgroundColor: ThemeApp.appBackgrounColor,
        ...
        child: ListView(
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  children: [ /* stepperWidget(),  SizedBox(
                    height: height * .02,
                  ),*/
                    Container(
                      // height: height * 0.5,
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration:  BoxDecoration(
                                ...
                                border: Border.all(color:ThemeApp.packedButtonColor ),
                                color: ThemeApp.whiteColor,
                              ),
                      ...
                      Text(
                          ...
                          Row(
                            children: [
                              Icon(Icons.phone_in_talk_sharp,color: ThemeApp.tealButtonColor),
                    ...
                    priceDetails(),  SizedBox(
                      height: height * .01,
                    ),
                    proceedButton("Complete Order",ThemeApp.tealButtonColor, context, () {   Navigator.of(context).push(
                      MaterialPageRoute(
