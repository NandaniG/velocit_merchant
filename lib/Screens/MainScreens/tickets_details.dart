...
class TicketsDetailPageActivity extends StatefulWidget {
  ...
  @override
  State<TicketsDetailPageActivity> createState() => _TicketsDetailPageActivityState();
}
  ...
  Widget build(BuildContext context) {
   ...
   appBar: PreferredSize(
        ...
        child:   appBar_backWidget(
            context,
            appTitle(context, "Order ID - 1234567"),
            const SizedBox()),
      ),
              ...
              SizedBox(height:10),
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 20,),
                        Text("Attachment",style: TextStyle(fontSize: 20),),
                  Container(
